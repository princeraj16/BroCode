    ...
    <div className="min-h-screen bg-black py-12 sm:py-16">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="bg-gray-900 rounded-xl sm:rounded-2xl p-6 sm:p-8 md:p-12 mb-12 sm:mb-16"
        >
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-center">
            ...
            <div className="relative">
              ...
              />
              <div className="absolute inset-0 bg-yellow-400/20 rounded-lg sm:rounded-xl"></div>
            </div>
          </div>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 mb-12 sm:mb-16">
          <motion.div
            ...
            viewport={{ once: true }}
            className="bg-gray-900 rounded-lg sm:rounded-xl p-6 sm:p-8"
          >
            <div className="w-10 h-10 sm:w-12 sm:h-12 bg-yellow-400 rounded-full flex items-center justify-center mb-3 sm:mb-4">
        ...
        >
          <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-white mb-3 sm:mb-4">Meet the Team</h2>
          <p className="text-gray-400 text-base sm:text-lg">The trio behind the magic</p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 mb-12 sm:mb-16">
          {teamMembers.map((member, index) => (
            <motion.div
              ...
              className="bg-gray-900 rounded-lg sm:rounded-xl p-6 sm:p-8 text-center group hover:bg-gray-800 transition-colors"
            >
              ...
              <h3 className="text-white font-bold text-lg sm:text-xl mb-1 sm:mb-2">{member.name}</h3>
              <p className="text-yellow-400 font-medium mb-3 sm:mb-4 text-sm sm:text-base">{member.role}</p>
        ...
        <motion.div
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="bg-gradient-to-r from-yellow-400/10 to-orange-500/10 rounded-xl sm:rounded-2xl p-6 sm:p-8 md:p-12 text-center"
        >
          <h2 className="text-2xl sm:text-3xl font-bold text-white mb-6 sm:mb-8">What We Stand For</h2>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-8">
            <div>
              <div className="text-3xl sm:text-4xl mb-3 sm:mb-4">⚡</div>
              <h3 className="text-white font-bold text-base sm:text-lg mb-1 sm:mb-2">Speed</h3>
              <p className="text-gray-300 text-xs sm:text-sm">Lightning-fast delivery that beats your expectations</p>
            </div>
            <div>
              <div className="text-3xl sm:text-4xl mb-3 sm:mb-4">🤝</div>
              <h3 className="text-white font-bold text-base sm:text-lg mb-1 sm:mb-2">Trust</h3>
              <p className="text-gray-300 text-xs sm:text-sm">Reliable service you can count on, every single time</p>
            </div>
            <div>
              <div className="text-3xl sm:text-4xl mb-3 sm:mb-4">❤️</div>
              <h3 className="text-white font-bold text-base sm:text-lg mb-1 sm:mb-2">Community</h3>
              <p className="text-gray-300 text-xs sm:text-sm">Building connections one delivery at a time</p>
            </div>
          </div>
        </motion.div>
      </div>
