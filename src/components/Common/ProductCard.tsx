...
const ProductCard: React.FC<ProductCardProps> = ({ product, onClick }) => {
  ...
  return (
    <motion.div
      whileHover={{ y: -4 }}
      whileTap={{ scale: 0.98 }}
      className="bg-gray-900 rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition-all cursor-pointer group"
      onClick={onClick}
    >
      ...
      <div className="p-4">
        ...
        <button
          ...
          className="w-full bg-yellow-400 text-black font-semibold py-2 px-4 rounded-lg hover:bg-yellow-500 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center space-x-2"
        >
